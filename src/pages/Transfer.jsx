  ...
  const verifyDestinationAccount = async () => {
    ...
    try {
      ...
      if (account.accountNumber) {
        ...
        setError(
          'Destination account not found. Please check the account number.',
        );
      }
    } catch (error) {
    ...
    try {
      ...
      setError(
        error.response?.data?.message ||
          'An error occurred during transfer is here',
      );
    } finally {
      setLoading(false);
    }
              ...
              <div className="account-info">
                ...
                <div className="account-details">
                  ...
                  <p>
                    ...
                    <span
                      className={`status ${destinationAccountInfo.status.toLowerCase()}`}
                    >
                      {destinationAccountInfo.status}
                    </span>
                  </p>
                </div>
              </div>
